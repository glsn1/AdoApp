...
namespace _1_AdoIntro {
    ...
    public partial class NorthwindDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeesRow AddEmployeesRow(string LastName, string FirstName, string City, string Country) {
...
namespace _1_AdoIntro.NorthwindDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employees] WHERE (([EmployeeID] = @Original_EmployeeID) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ([FirstName] = @Original_FirstName) AND ((@IsNull_City = 1 AND [City] IS NULL) OR ([City] = @Original_City)) AND ((@IsNull_Country = 1 AND [Country] IS NULL) OR ([Country] = @Original_Country)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([LastName], [FirstName], [City], [Country]) VALUES" +
                " (@LastName, @FirstName, @City, @Country);\r\nSELECT EmployeeID, LastName, FirstNa" +
                "me, City, Country FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [LastName] = @LastName, [FirstName] = @FirstName, [City] = @City, [Country] = @Country WHERE (([EmployeeID] = @Original_EmployeeID) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ([FirstName] = @Original_FirstName) AND ((@IsNull_City = 1 AND [City] IS NULL) OR ([City] = @Original_City)) AND ((@IsNull_Country = 1 AND [Country] IS NULL) OR ([Country] = @Original_Country)));
SELECT EmployeeID, LastName, FirstName, City, Country FROM Employees WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::_1_AdoIntro.Properties.Settings.Default.NorthwindConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, LastName, FirstName, City, Country FROM dbo.Employees";
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_LastName, string Original_FirstName, string Original_City, string Original_Country) {
        ...
        public virtual int Insert(string LastName, string FirstName, string City, string Country) {
            if ((LastName == null)) {
        ...
        public virtual int Update(string LastName, string FirstName, string City, string Country, int Original_EmployeeID, string Original_LastName, string Original_FirstName, string Original_City, string Original_Country, int EmployeeID) {
            if ((LastName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string LastName, string FirstName, string City, string Country, int Original_EmployeeID, string Original_LastName, string Original_FirstName, string Original_City, string Original_Country) {
            return this.Update(LastName, FirstName, City, Country, Original_EmployeeID, Original_LastName, Original_FirstName, Original_City, Original_Country, Original_EmployeeID);
        }
    }
